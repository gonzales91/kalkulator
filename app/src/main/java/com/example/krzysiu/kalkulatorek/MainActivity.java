package com.example.krzysiu.kalkulatorek;
...
public class MainActivity extends ActionBarActivity {
    ...
    public void onClickminus(View a)
    {
        if(a.getId() == R.id.badd2)
        {
            EditText a1 = (EditText)findViewById(R.id.TFnumber1);
            EditText a2 = (EditText)findViewById(R.id.TFnumber2);
    ...
    public void onClickmno(View a)
    {
        if(a.getId() == R.id.badd3)
        {
            EditText a1 = (EditText)findViewById(R.id.TFnumber1);
            EditText a2 = (EditText)findViewById(R.id.TFnumber2);
    ...
    public void onClickdziel(View a)
    {
        if(a.getId() == R.id.badd4)
        {
            EditText a1 = (EditText)findViewById(R.id.TFnumber1);
            EditText a2 = (EditText)findViewById(R.id.TFnumber2);
